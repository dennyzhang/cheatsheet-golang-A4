...
| Use pointer of array list       | [[file:code/pointer_array.go][code/pointer_array.go]]                    |
...
| Name            | Comment                   |
|-----------------+---------------------------|
| Basic goroutine | [[file:code/example_goroutine.go][code/example_goroutine.go]] |
...
| Name        | Comment                    |
|-------------+----------------------------|
| Read files  | [[file:code/example_read_file.go][code/example_read_file.go]] |
| Write files | [[file:code/example_write_file.go][code/example_write_file.go]] |
